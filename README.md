...
- `/api/data?action=tables` - List all tables
- `/api/data?action=structure&table=table_name` - Get table structure
- `/api/data?action=sample&table=table_name` - Get sample data
- `/api/data?action=query&query=SELECT * FROM table` - Execute custom query
