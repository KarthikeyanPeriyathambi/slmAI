...
// export default function MatrixLoading() {
//   // Commenting out matrix effect for now - can be re-enabled later
//   /*
//   const [columns, setColumns] = useState<Array<{ id: number; characters: string[] }>>([]);
...
//       {/* Matrix background - commented out for now */}
//       {/*
//       <div className="absolute inset-0 flex" style={{ width: '100%', height: '100%' }}>
//         {columns.map((column) => (
//           <div 
...
//                 <div className="w-16 h-16 border-2 border-dashed border-blue-400 rounded-full"></div>
//               </div>
//             </div>
//           </div>
//         </div>
...
//       {/* Custom styles for animations - commented out with matrix effect */}
//       {/*
//       <style jsx>{`
//         @keyframes fadeInOut {
//           0% { opacity: 0; }
